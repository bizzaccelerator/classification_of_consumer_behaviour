...
# __Key Takeaways:__ 
# 
# - Upper categories of *user_behavior_class* exhibit higher data consumption, greater screen exposure, increased battery usage, and a larger number of apps installed on their phones.
# - The variables 'device_model', 'gender', 'operating_system', and 'age' do not show a statistically significant relationship with the target variable, 'user_behavior_class'.
# - The variables 'app_usage_time_(min/day)', 'battery_drain_(mah/day)', 'number_of_apps_installed','data_usage_(mb/day)', and 'screen_on_time_(min/day)' show a statistically significant relationship with the target variable, 'user_behavior_class'. Therefore, these will be used in the model.
